        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.status == 'due') {
                    ...
                    minDate = new Date($('#paid_on').attr('data-min-date'));
                    __currency_convert_recursively(container);
                    $('#paid_on').datetimepicker({
                        format: moment_date_format + ' ' + moment_time_format,
                        ignoreReadonly: true
                    });
                    if($('#paid_on').attr('data-min-date')){
                        // $('#paid_on').datepicker( "option", "minDate", minDate);
                        $('#paid_on').data("DateTimePicker").minDate(minDate);
                    }
