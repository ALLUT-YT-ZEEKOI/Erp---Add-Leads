...
function initializeDocumentAndNoteDataTable() {
    documents_and_notes_data_table = $('#documents_and_notes_table').DataTable({
        ...
        "initComplete": function() {
            if (typeof documentAndNoteDataTableCallback === 'function') {
                documentAndNoteDataTableCallback(documents_and_notes_data_table);
            }
        },
        ajax:{
            url: '/note-documents',
        ...
        columns: [
            ...
            { data: 'staging_id', name: 'staging_id' },
            { data: 'createdBy'},
            { data: 'notification_date', name: 'notification_date', visible:false },
